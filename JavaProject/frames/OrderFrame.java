...
public class OrderFrame extends JFrame  implements ActionListener
{
	...
	
	{
		...
		totalBtn.setBackground(Color.GRAY);
    ...
    public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(updateQuantityBtn.getText()))
		{
			...
			/*sl.setSlPrdctName(itemNameTF.getText());
			sl.setSlQuantity(Integer.parseInt(orderQuantityTF.getText()));
			sl.setSlAmount(Double.parseDouble(itemPriceTF.getText()));
		
		    sr.insertSalesInformation(sl);*/
