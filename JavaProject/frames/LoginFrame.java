...
public class LoginFrame extends JFrame implements ActionListener, MouseListener
{
	...
	public LoginFrame()
	{
		...
		/*title = new JLabel("Cafe Service Management System");
		title.setBounds(300, 50, 350, 30);
		title.setFont(myFont1);
		panel.add(title);*/
		
		userLabel = new JLabel("User ID : ");
		userLabel.setBounds(260, 200, 130, 30);
		...
		passLabel.setBounds(260, 240, 130, 30);
		...
		userTF.setBounds(410, 200, 120, 30);
		userTF.setForeground(Color.BLUE);
		panel.add(userTF);
		
		
		passPF = new JPasswordField();
		passPF.setBounds(410, 240, 120, 30);
		panel.add(passPF);
		
		showPassBtn = new JButton("Show");
		showPassBtn.setBounds(535,240,80,30);
		showPassBtn.addMouseListener(this);
		panel.add(showPassBtn);
		
		loginBtn = new JButton("Login");
		loginBtn.setBounds(260, 300, 115, 30);
		...
		exitBtn.setBounds(410, 300, 100, 30);
		...
		regBtn.setBounds(330, 340, 130, 30);
